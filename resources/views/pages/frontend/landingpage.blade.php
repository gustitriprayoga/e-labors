@extends('layouts.landingpage.masters')
...
@section('content')
    ...
    <div class="section pb-0">
        <div class="container">
            <div class="row">
                <h4 class="text-center fw-semibold">Daftar</h4>
                <span class="landing-title"></span>
                <h2 class="text-center fw-semibold mb-7">Laboratorium</h2>
            </div>
                            ...
                            <div class="card-body bg-primary-transparent">
                                <div class="counter-status">
                                    ...
                                    <div class="test-body text-center">
                                        <h1 class=" mb-0">
                                            <span class="counter fw-semibold counter ">{{ $item->nama_labor }}</span>
                                        </h1>
                                        <div class="counter-text">
                                            <h5 class="font-weight-normal mb-0 "> {{ $item->status_labor }} </h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="sptb section bg-white" id="Features">
        <div class="container">
            <div class="row">
                <h4 class="text-center fw-semibold">Tentang E-Labs</h4>
                <span class="landing-title"></span>
                <h2 class="fw-semibold text-center">Penggunaan E-Labs</h2>
                <p class="text-default mb-5 text-center">Harap Di Perhatikan Sebelum Menggunakan</p>
                <div class="row mt-7">
                    <div class="col-lg-6 col-md-12">
                        <div class="card features main-features main-features-1 wow fadeInUp reveal revealleft"
                            ...
                            <div class="text-left">
                                <h4 class="fw-bold">Terdaftar &amp; Di E-labs UP</h4>
                                <p class="mb-0">Agar Dapat Masuk Ke Dashboard E-Labs</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12">
                        <div class="card  features main-features main-features-2 wow fadeInUp reveal revealleft"
                            data-wow-delay="0.1s">
                            <div class="bg-img mb-2 text-left">
                                <!-- <img src="backend/landing/images/features/demo.png" alt=""> -->
                                <svg width="50" height="50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                            ...
                            <div class="text-left">
                                <h4 class="fw-bold">Gampang Untuk Di Gunakan</h4>
                                <p class="mb-0">
                                    Dengan UI/UX yang gampang untuk digunakan dan dimengerti.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12">
                        <div class="card features main-features main-features-11 wow fadeInUp reveal revealleft"
                            ...
                            <div class="text-left">
                                <h4 class="fw-bold">Mengisi Form Peminjaman</h4>
                                <p class="mb-0">
                                    Mengisi Form Peminjaman E-Labs sesuai dengan Kebutuhan.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12">
                        <div class="card features main-features main-features-10 wow fadeInUp reveal revealleft"
                            ...
                            <div class="text-left">
                                <h4 class="fw-bold">Status Pengajuan</h4>
                                <p class="mb-0">
                                    Melihat Status Pengajuan yang sudah diajukan di E-Labs
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12">
                        <div class="card features main-features main-features-9 wow fadeInUp reveal revealleft"
                            ...
                            <div class="text-left">
                                ...
                                <p class="mb-0">
                                    Melihat Jadwal Yang Telah Tertera Pada E-Labs.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12">
                        <div class="card features main-features main-features-12 mb-4 wow fadeInUp reveal revealleft"
                            ...
                            <div class="text-left">
                                ...
                                <p class="mb-0">
                                    Melihat status peminjaman dan pengajuan yang telah di terima/t.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="card bg-transparent mb-0">
                    <h4 class="text-center fw-semibold text-white">E-Labs</h4>
                    <span class="landing-title"></span>
                    <div class="demo-screen-skin code-quality" id="dependencies">
                        <div class="text-center p-0">
                            <h2 class="text-center fw-semibold text-white">Laboratorium</h2>
                            <div class="row justify-content-center">
                                <div class="col-lg-12 px-0">
                                    <div class="feature-logos mt-5">
                                        ...
                                        <div class="slide">
                                            <img src="{{asset('asset/backend/images/landing/web/1.png')}}" alt="image">
                                            <h5 class="mt-3 text-white"> {{ $item->nama_prodi }}</h5>
                                        </div>
                                    ...
                                    <div class="card p-3 pricing-card reveal revealrotate">
                                        <div class="card-header d-block text-justified pt-2">
                                            ...
                                            <p class="text-justify fw-semibold mb-1"> <span
                                                    class="fs-30 me-2">$</span><span class="fs-30 me-1">399</span><span
                                    ...
                                    <div class="card p-3 border-primary pricing-card advanced reveal revealrotate">
                                        <div class="card-header d-block text-justified pt-2">
                                            <p class="fs-18 fw-semibold mb-1 pe-0">Advanced<span
                                                    ...
                                                    Deal</span></p>
                                            <p class="text-justify fw-semibold mb-1"> <span
                                                    class="fs-30 me-2">$</span><span class="fs-30 me-1">1,299</span><span
                                                    class="fs-25"><span class="op-0-5 text-muted text-20">/</span>
                                                    year</span></p>
                                ...
                                <div class="col-lg-4 col-xl-4 col-md-8 col-sm-12">
                                    <div class="card p-3 pricing-card reveal revealrotate">
                                        <div class="card-header d-block text-justified pt-2">
                                            ...
                                            <p class="text-justify fw-semibold mb-1"> <span
                                                    class="fs-30 me-2">$</span><span class="fs-30 me-1">899</span><span
                                                    class="fs-25"><span class="op-0-5 text-muted text-20">/</span>
                                                    year</span></p>
                                            <p class="fs-13 mb-1">Lorem ipsum dolor sit amet
                                                consectetur adipisicing elit. Iure quos debitis
                                ...
                                <div class="col-lg-4 col-xl-4 col-md-8 col-sm-12">
                                    <div class="card p-3 pricing-card">
                                        <div class="card-header d-block text-justified pt-2">
                                            <p class="fs-18 fw-semibold mb-1">Basic</p>
                                            <p class="text-justify fw-semibold mb-1"> <span
                                                    class="fs-30 me-2">$</span><span class="fs-30 me-1">39</span><span
                                                    class="fs-25"><span class="op-0-5 text-muted text-20">/</span>
                                                    month</span></p>
                                            <p class="fs-13 mb-1">Lorem ipsum dolor sit amet
                                                consectetur adipisicing elit. Iure quos debitis
                                    ...
                                    <div class="card p-3 border-primary pricing-card advanced">
                                        <div class="card-header d-block text-justified pt-2">
                                            <p class="fs-18 fw-semibold mb-1 pe-0">Advanced<span
                                                    ...
                                                    Deal</span></p>
                                            <p class="text-justify fw-semibold mb-1"> <span
                                                    class="fs-30 me-2">$</span><span class="fs-30 me-1">199</span><span
                                                    class="fs-25"><span class="op-0-5 text-muted text-20">/</span>
                                                    month</span></p>
                                            <p class="fs-13 mb-2">Lorem ipsum dolor sit amet
                                                consectetur adipisicing elit. Iure quos debitis
                                ...
                                <div class="col-lg-4 col-xl-4 col-md-8 col-sm-12">
                                    <div class="card p-3 pricing-card">
                                        <div class="card-header d-block text-justified pt-2">
                                            <p class="fs-18 fw-semibold mb-1">Regular</p>
                                            <p class="text-justify fw-semibold mb-1"> <span
                                                    class="fs-30 me-2">$</span><span class="fs-30 me-1">69</span><span
                                                    class="fs-25"><span class="op-0-5 text-muted text-20">/</span>
                                                    month</span></p>
                                            <p class="fs-13 mb-1">Lorem ipsum dolor sit amet
                                                consectetur adipisicing elit. Iure quos debitis
                ...
                <section class="sptb demo-screen-demo" id="faqs1">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-12 col-lg-6 reveal revealright">
                            <img src="backend/images/landing/2.png" alt="">
                        </div>
                    </div>
                </section>
            </div>
                        ...
                        <div class="card-body px-1">
                            <div class="d-flex overflow-visible">
                                <a href="blog-details.html" class="card-aside-column br-5 cover-image"
                                    data-bs-image-src="backend/images/media/12.jpg"
                                    style="background: url(&quot;backend/images/media/12.jpg&quot;) center center;"></a>
                ...
                <div class="col-lg-6">
                    <div class="card bg-transparent reveal">
                        <div class="card-body px-1">
                            <div class="d-flex overflow-visible">
                                <a href="blog-details.html" class="card-aside-column br-5 cover-image"
                                    data-bs-image-src="backend/images/media/22.jpg"
                                    style="background: url(&quot;backend/images/media/22.jpg&quot;) center center;"></a>
                                <div class="ps-3 flex-column">
                ...
                <div class="col-lg-6">
                    <div class="card bg-transparent reveal">
                        <div class="card-body px-1">
                            <div class="d-flex overflow-visible">
                                <a href="blog-details.html" class="card-aside-column br-5 cover-image"
                                    data-bs-image-src="backend/images/media/28.jpg"
                                    style="background: url(&quot;backend/images/media/28.jpg&quot;) center center;"></a>
                                <div class="ps-3 flex-column">
                ...
                <div class="col-lg-6">
                    <div class="card bg-transparent reveal">
                        <div class="card-body px-1">
                            <div class="d-flex overflow-visible">
                                <a href="blog-details.html" class="card-aside-column br-5 cover-image"
                                    data-bs-image-src="backend/images/media/25.jpg"
                                    style="background: url(&quot;backend/images/media/25.jpg&quot;) center center;"></a>
                                <div class="ps-3 flex-column">
                                            ...
                                            <div class="testimonia">
                                                ...
                                                <div class="testimonia-data">
                                                    ...
                                                    <div class="rating-stars">
                                                        <div class="rating-stars block my-rating-5 mb-5" data-rating="5">
                                                        </div>
                                                        <div class="owl-controls clickable">
                                                            <div class="owl-pagination">
                                                                <div class="owl-page ">
