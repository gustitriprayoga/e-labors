        ...
        <div class="main-bar clearfix ">
            <div class="container clearfix">
                ...
                <div class="logo-header">
                    <a href="index.html" class="logo-dark"><img src="{{ asset('asset/frontend/images/logo.png') }}"
                            alt=""></a>
                </div>
                ...
                <div class="extra-nav">
                    <div class="extra-cell">
                        @auth
                            ...
                            <a class="btn btn-dark btn-sm btn-shadow" target="_blank"
                                href="{{ route('dashboard') }}">Dashboard</a>

                            <form method="POST" action="{{ route('logout') }}">
                                @csrf

                                <button type="submit" class="btn btn-dark btn-sm btn-shadow">Logout</button>
                            </form>
                        @else
                            <button id="quik-search-btn" type="button" class="header-search-btn"><i
                                    class="fa-solid fa-magnifying-glass"></i></button>
                            <a class="btn btn-dark btn-sm btn-shadow" target="_blank" href="{{ route('login') }}">login</a>
                        @endauth
